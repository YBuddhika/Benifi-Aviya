<?php
  class Users extends Controller {
    ...
    public function createUserSession($email,$name){
      ...
      // redirect('users/beneficiary/dashboard');
    ...
    public function dashboard(){
      ...
      $this->view('users/beneficiary/events',$data);
    ...
    public function form(){
      ...
      $this->view('users/beneficiary/form',$data);
    ...
    public function addevent(){
      ...
      if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $data =[
         ...
         if($this->userModel->addevent($data)){
                        // flash('category_message', 'Category Added');
                        redirect('beneficiary/events');
                    } else {
                        die('Something went wrong');
                    }
