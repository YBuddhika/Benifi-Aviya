    ...
    <section class="home-section">
        ...
        <main>
            <div class="container">
                ...
                <form method="post" action="<?php echo URLROOT; ?>/EOrganizer/Addevent">
                    <div class="formfirst">
                        ...
                        <div class="ggg">
                            <div class="photo-container">
                                <input type="file" id="file" accept="image/*" hidden name="thumb" value="<?php echo $data['img1']; ?>">
                            ...
                            <div class="photo-container">
                                <input type="file" id="file2" accept="image/*" hidden name="passbook" value="<?php echo $data['img2']; ?>">
